...
export function createApp(): Application {
  ...
  app.use(
    helmet({
      // Default helmet CSP is stricter than swagger-ui-express needs (it
      // injects small inline init scripts/styles for /api/docs) — this API
      // otherwise serves JSON only, so the rest stays locked to 'self'.
